...
const HelpCenter = () => {
  return (
    <section className="dark:bg-gray-100 dark:text-gray-800 min-h-screen">
      <Helmet>
        <title>Luxury Estate | Help Center</title>
      </Helmet>
      <div className="container flex flex-col items-center p-4 mx-auto md:p-8">
        ...
        <div className="relative mt-6 mb-12">
          ...
          <input
            ...
            name="Search"
            placeholder="Search..."
            className="w-full py-3 pl-12 text-sm rounded-full sm:w-96 focus:outline-none dark:bg-gray-100 dark:text-gray-800 focus:dark:bg-gray-50 border"
          />
        </div>
